...
import sys
sys.path.append('/home/yuyuanyuan/SECE-master/SECE')
...
class SECE_model(object):
    ...
    def predict_model1(self):
        ...
        self.model1.eval()
        dataloader = DataLoader(self.dataset1, shuffle=False, batch_size=len(self.dataset1), num_workers=self.num_workers)
